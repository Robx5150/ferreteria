...
public class VentaServiceImpl implements VentaService {
	...
	private final ProductoService productoService;
	  ...
	  @Transactional
	  @Override 
	  public VentaDTO crearVenta(VentaCreateDTO ventaCreateDto ) {
		  ...
		  productoService.validarSkusExistentes(skus); // Validar que los SKUs existen
		    
		  Venta venta = new Venta(ventaCreateDto.numeroFactura(), ventaCreateDto.usuario());

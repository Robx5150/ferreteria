...
public class VentasController {
	...
	@PostMapping() 
	public ResponseEntity<VentaDTO> crearVenta(@Valid @RequestBody VentaCreateDTO postDTO,
																   JwtAuthenticationToken jwt) throws VentaDuplicadaException{
		   String usuario = jwt.getToken().getClaimAsString("preferred_username");
		  
		  VentaDTO ventaCreada = ventaService.crearVenta(postDTO, usuario);
	...
	public List<VentaResumenDTO> listarVentasResumen() {
	    ...
	    return ventaService.listarVentasResumen();
	}
